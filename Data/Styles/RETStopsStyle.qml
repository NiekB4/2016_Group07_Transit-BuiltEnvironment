...
<qgis version="2.14.3-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="desc">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="StopType" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="A_Bus" label="Added bus stop"/>
      <category render="true" symbol="1" value="A_Metro" label="Added metro stop"/>
      <category render="true" symbol="2" value="A_Tram" label="Added tram stop"/>
      <category render="true" symbol="3" value="E_Bus" label="Bus stop"/>
      <category render="true" symbol="4" value="E_Metro" label="Metro stop"/>
      <category render="true" symbol="5" value="E_Tram" label="Tram stop"/>
    </categories>
    <symbols>
      <symbol alpha="0.941176" clip_to_extent="1" type="marker" name="0">
      ...
      <symbol alpha="0.941176" clip_to_extent="1" type="marker" name="1">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,255,255,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol alpha="0.941176" clip_to_extent="1" type="marker" name="2">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,255,255,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol alpha="0.666667" clip_to_extent="1" type="marker" name="3">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,255,255,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol alpha="0.694118" clip_to_extent="1" type="marker" name="4">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
      ...
      <symbol alpha="0.666667" clip_to_extent="1" type="marker" name="5">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,255,255,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="StopType"/>
